...
<head>
	...
	<title>Calculate Mass - ChemAstro Software by Dynamic Developers</title>
	<meta name="description" content="Calculate mass of solution with the help of chemastro software by Dynamic Developers. Find mass with number of moles and molar mass.">
	...
	<body>
      ...
      <h1>Calculate Mass...!</h1>
    </div>
		
		<form action="" method="POST">
			<div class="container wow bounceInUp">
				<h4>Write No. of Moles:</h4>
				<input class="taxt" type="text" name="num1">
			
				<h4>Write Molar Mass:</h4>
...
?>
				...
				<h4>Result :</h4>
				<input class="txt" type="text" name="result" value="<?php echo $sum; ?> gram" >
			</div>
