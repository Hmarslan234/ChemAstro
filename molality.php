...
<head>
	...
	<body>
      ...
      <h1>Calculate Molality (m)...!</h1>
    </div>
		
		<form action="" method="POST">
			<div class="container wow bounceInUp">
				<h4>Write Moles of Solute:</h4>
				<input class="taxt" type="text" name="num1">
			
				<h4>Write Mass of Solvent in kg:</h4>
...
?>
				...
				<h4>Result :</h4>
				<input class="txt" type="text" name="result" value="<?php echo $sum; ?> mole/kg" >
		</div>
	</form>
