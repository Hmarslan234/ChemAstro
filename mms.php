...
<head>
	...
	<body>
      ...
      <h1>Calculate Molarity (M) For Mixed Solution</h1>
    </div>
		
		<form action="" method="POST">
			<div class="container wow bounceInUp">

				<h4>Write Molarity of Acid (M<sub>1</sub>) :</h4>
				...
				<input class="taxt" type="text" name="num4">

				<h4>Write No. of Moles of Acid (n<sub>1</sub>) :</h4>
				<input class="taxt" type="text" name="num5">

				<h4>Write No. of Moles of Base (n<sub>2</sub>) :</h4>
				<input class="taxt" type="text" name="num6"><br><br>
